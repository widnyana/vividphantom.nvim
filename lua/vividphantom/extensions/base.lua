...
function M.get(opts, t)
    ...
    return {
        ...
        Search = { fg = t.bg_solid, bg = t.fg },
        IncSearch = { fg = t.bg_solid, bg = t.cyan },
        CurSearch = { fg = t.bg_solid, bg = t.cyan },
        ...
        WildMenu = { fg = t.bg_solid, bg = t.blue },
